...
This experiment was created using PsychoPy2 Experiment Builder (v1.90.2),
    on Thu 23 Aug 2018 12:38:13 IST
...
expName = 'Robot_Voice'  # from the Builder filename that created this script
...
# Setup the Window
win = visual.Window(
    size=[1440, 810], fullscr=True, screen=0,
...
image = visual.ImageStim(
    ...
    image='robot_imgs/pepper', mask=None,
    ori=0, pos=(0, 0), size=(768/3,950/3),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-3.0)
image_2 = visual.ImageStim(
    win=win, name='image_2',units='pix', 
    image='robot_imgs/pr2', mask=None,
    ori=0, pos=(-50-(768/3),9, 0), size=(768/3,950/3),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
instructionsComponents = [instText, key_resp_3]
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('sounds.xlsx'),
...
for thisTrial in trials:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    target.setText(task_2

)
    response = event.BuilderKeyResponse()
    sound_1.setSound(task_2, secs=6)
    # keep track of which components have finished
    trialComponents = [target, response, sound_1, image, image_2]
